...
export const MOCK_CATEGORIES = [
  ...
  { id: 'characters', label: '3D Characters', icon: 'User' },
  { id: 'props', label: 'Props & Items', icon: 'Box' },
  { id: 'weapons', label: 'Weapons', icon: 'Sword' },
  { id: 'vehicles', label: 'Vehicles', icon: 'Car' },
  { id: 'environments', label: 'Environments', icon: 'Layers' },
  { id: 'vfx', label: 'VFX', icon: 'Sparkles' },
  { id: 'ui', label: 'UI Kits', icon: 'Box' },
  { id: 'music', label: 'SFX & Music', icon: 'Music' },
];
...
export const MOCK_CREATORS = [
  {
    ...
    avatar: 'https://api.dicebear.com/8.x/thumbs/svg?seed=leafwork&backgroundColor=ffd2aa,fff0df,ffe4c4&shapeColor=ff9f4a,c0714a',
    specialty: 'Stylized Characters & Creatures',
    rating: 4.9,
    completedJobs: 42,
    hourlyRate: '/hr'
  },
  {
    id: 'c2',
    name: 'stonearch',
    role: 'Environment & Prop Specialist',
    location: 'Vancouver, Canada',
    avatar: 'https://api.dicebear.com/8.x/thumbs/svg?seed=stonearch&backgroundColor=ffd2aa,fff0df,ffe4c4&shapeColor=ff9f4a,c0714a',
    specialty: 'PBR Props & Modular Environments',
    rating: 5.0,
    completedJobs: 58,
    hourlyRate: '/hr'
  },
  {
    id: 'c3',
    name: 'neonpulse',
    role: 'Sci-Fi & Cyberpunk Modeler',
    location: 'Berlin, Germany',
    avatar: 'https://api.dicebear.com/8.x/thumbs/svg?seed=neonpulse&backgroundColor=ffd2aa,fff0df,ffe4c4&shapeColor=ff9f4a,c0714a',
    specialty: 'Hard-surface & Rigged Vehicles',
    rating: 4.8,
    completedJobs: 31,
    hourlyRate: '/hr'
  }
